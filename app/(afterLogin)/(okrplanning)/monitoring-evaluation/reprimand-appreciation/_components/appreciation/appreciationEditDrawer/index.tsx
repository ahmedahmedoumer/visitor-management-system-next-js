...
import { useUpdateAppLog } from '@/store/server/features/okrplanning/monitoring-evaluation/appreciation-log/mutations';
...
const AppreciationEditDrawer: React.FC<AppDrawerProps> = ({
  appLog,
  onClose,
  open,
}) => {
...
export default AppreciationEditDrawer;
